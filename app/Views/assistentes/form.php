                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="text" class="form-control" name="assistente_cress" id="assistente_cress" placeholder="Digite o CRESS" value="<?php echo !empty($assistente['assistente_cress']) ? $psicologo['assistente_cress'] : set_value('assistente_cress') ?>" >
