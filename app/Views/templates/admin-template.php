        ...
        <nav class="mt-2">
          ...
          <!-- Add icons to the links using the .nav-icon class
           ...
           <li class="nav-item">
            ...
            <a href="<?php echo base_url();?>/dashboard" class="nav-link <?php if($ativo=="Dashboard"){echo "active";}else { echo ""; } ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>/psicologo" class="nav-link <?php if($ativo=="Psicologo"){echo "active";}else { echo ""; } ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url();?>/assistente" class="nav-link <?php if($ativo=="Assistente"){echo "active";}else { echo ""; } ?>">
              <i class="nav-icon fa fa-user-md"></i>
